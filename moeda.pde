class Moeda {
  float posX;
  float posY;
  PImage imgCoin1 = loadImage("coin_v.png");
  PImage imgCoin2 = loadImage("coin_h.png");
  PImage img;
  final int CIMA = 1;
  final int LADO = 2;
  int time;
...
void initPosMoedas () {
  // Position 0
  posMoedas[0][0] = 2*width/12; 
  posMoedas[0][1] = 6*width/12; 
  posMoedas[0][2] = 10*width/12; 
  posMoedas[0][3] = -10; 
  posMoedas[0][4] = -90; 
  posMoedas[0][5] = -170; 
  posMoedas[0][6] = -250;  
  ...
  //Position 1 
  posMoedas[1][0] = 2*width/12; 
  posMoedas[1][1] = 6*width/12;  
  posMoedas[1][2] = 10*width/12;
  posMoedas[1][3] = -10; 
  posMoedas[1][4] = -90; 
  posMoedas[1][5] = -170; 
  posMoedas[1][6] = -250;  
  ...
  //Position 2
  posMoedas[2][0] = 2*width/12; 
  posMoedas[2][1] = 6*width/12; 
  posMoedas[2][2] = 10*width/12; 
  posMoedas[2][3] = -250; 
  posMoedas[2][4] = -330; 
  posMoedas[2][5] = -410; 
  posMoedas[2][6] = -490;  
  ...
  //Position 3
  posMoedas[3][0] = 2*width/12; 
  posMoedas[3][1] = 6*width/12; 
  posMoedas[3][2] = 10*width/12; 
  posMoedas[3][3] = -250; 
  posMoedas[3][4] = -330; 
  posMoedas[3][5] = -410; 
  posMoedas[3][6] = -490;  
  ...
  //Position 4
  posMoedas[4][0] = 2*width/12; 
  posMoedas[4][1] = 6*width/12; 
  posMoedas[4][2] = 10*width/12;
  posMoedas[4][3] = -10; 
  posMoedas[4][4] = -90; 
  posMoedas[4][5] = -170; 
  posMoedas[4][6] = -250;  
  ...
  //Position 5
  posMoedas[5][0] = 2*width/12; 
  posMoedas[5][1] = 6*width/12; 
  posMoedas[5][2] = 10*width/12;
  posMoedas[5][3] = -250; 
  posMoedas[5][4] = -330; 
  posMoedas[5][5] = -420; 
  posMoedas[5][6] = -490;  
